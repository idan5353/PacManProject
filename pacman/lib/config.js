var service_host = 'mongodb-headless'
var auth_details = ''
...
var hosts = service_host + '/mongodb-headless' // Use the headless service for StatefulSet
var connection_details = `${hosts}:${mongo_port}`
